...
const SearchableDropdown = ({ id, label, items, selectedValue, placeholder, onValueChange }) => {
            ...
            <Popover open={open} onOpenChange={(isOpen) => {
                ...
                <PopoverTrigger asChild>
                    <Button
                        ...
                        role="combobox"
                        aria-expanded={open}
                        className={selectedValue ? "w-full justify-between truncate" : "w-full justify-between text-muted-foreground font-normal "}
                    >
