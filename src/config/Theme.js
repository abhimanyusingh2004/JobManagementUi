export const defaultPresets = {
  default: {
    ...
    styles: {
      light: {
        ...
        radius: "0.625rem",
        "shifts-1": "oklch(0.97 0.045 64.07)",
        "shifts-2": "oklch(0.95 0.03 264.064)",
        "shifts-3": "oklch(0.95 0.03 128.64)",
        "shifts-4": "oklch(0.95 0.03 128.64)",
        "shifts-5": "oklch(0.96 0.005 0)",
        "shifts-unassigned": "oklch(0.96 0.005 128.64)"
      },
      dark: {
        ...
        radius: "0.625rem",
        "shifts-1": "oklch(0.20 0.030 264.531)",
        "shifts-2": "oklch(0.18 0.030 264.531)",
        "shifts-3": "oklch(0.16 0.030 264.531)",
        "shifts-4": "oklch(0.14 0.030 264.531)",
        "shifts-5": "oklch(0.12 0.030 264.531)",
        "shifts-unassigned": "oklch(0.96 0.030 264.531)"
      },
    },
  },
  theme1: {
    ...
    styles: {
      light: {
        background: "hsl(233, 47%, 98%)",
        foreground: "hsl(233, 61%, 5%)",
        muted: "hsl(353, 17%, 94%)",
        "muted-foreground": "hsl(353, 4%, 39%)",
        popover: "hsl(233, 47%, 98%)",
        "popover-foreground": "hsl(233, 61%, 5%)",
        card: "hsl(233, 47%, 98%)",
        "card-foreground": "hsl(233, 61%, 5%)",
        border: "hsl(233, 14%, 92%)",
        input: "hsl(233, 14%, 92%)",
        primary: "hsl(233, 45%, 21%)",
        "primary-foreground": "hsl(233, 45%, 81%)",
        secondary: "hsl(353, 45%, 21%)",
        "secondary-foreground": "hsl(353, 45%, 81%)",
        accent: "hsl(113, 45%, 21%)",
        "accent-foreground": "hsl(113, 45%, 81%)",
        destructive: "hsl(14, 100%, 40%)",
        "destructive-foreground": "hsl(0, 0%, 100%)",
        ring: "hsl(233, 45%, 21%)",
        "chart-1": "hsl(233, 45%, 21%)",
        "chart-2": "hsl(353, 45%, 21%)",
        "chart-3": "hsl(113, 45%, 21%)",
        "chart-4": "hsl(353, 45%, 24%)",
        "chart-5": "hsl(233, 48%, 21%)",
        radius: "0.5rem",
        sidebar: "hsl(233, 47%, 99%)",
        "sidebar-foreground": "hsl(233, 61%, 5%)",
        "sidebar-primary": "hsl(233, 45%, 21%)",
        "sidebar-primary-foreground": "hsl(233, 45%, 81%)",
        "sidebar-accent": "hsl(113, 45%, 21%)",
        "sidebar-accent-foreground": "hsl(113, 45%, 81%)",
        "sidebar-border": "hsl(233, 14%, 92%)",
        "sidebar-ring": "hsl(233, 45%, 21%)",
        "font-sans": "Inter, sans-serif",
        "font-serif": "Georgia, serif",
        "font-mono": "Menlo, monospace",
        "shifts-1": "hsl(233, 45%, 25%)",
        "shifts-2": "hsl(233, 45%, 30%)",
        "shifts-3": "hsl(233, 45%, 35%)",
        "shifts-4": "hsl(233, 45%, 40%)",
        "shifts-5": "hsl(233, 45%, 45%)",
        "shifts-unassigned": "hsl(233, 20%, 85%)"
      },
      dark: {
        background: "hsl(233, 60%, 3%)",
        foreground: "hsl(233, 22%, 99%)",
        muted: "hsl(353, 17%, 6%)",
        "muted-foreground": "hsl(353, 4%, 61%)",
        popover: "hsl(233, 60%, 3%)",
        "popover-foreground": "hsl(233, 22%, 99%)",
        card: "hsl(233, 60%, 3%)",
        "card-foreground": "hsl(233, 22%, 99%)",
        border: "hsl(233, 14%, 15%)",
        input: "hsl(233, 14%, 15%)",
        primary: "hsl(233, 45%, 21%)",
        "primary-foreground": "hsl(233, 45%, 81%)",
        secondary: "hsl(353, 45%, 21%)",
        ...
        "chart-5": "hsl(233, 48%, 21%)",
        radius: "0.5rem",
        sidebar: "hsl(233, 60%, 4%)",
        "sidebar-foreground": "hsl(233, 22%, 99%)",
        "sidebar-primary": "hsl(233, 45%, 21%)",
        "sidebar-primary-foreground": "hsl(233, 45%, 81%)",
        "sidebar-accent": "hsl(113, 45%, 21%)",
        "sidebar-accent-foreground": "hsl(113, 45%, 81%)",
        "sidebar-border": "hsl(233, 14%, 15%)",
        "sidebar-ring": "hsl(233, 45%, 21%)",
        "font-sans": "Inter, sans-serif",
        "font-serif": "Georgia, serif",
        "font-mono": "Menlo, monospace",
        "shifts-1": "hsl(233, 45%, 15%)",
        "shifts-2": "hsl(233, 45%, 12%)",
        "shifts-3": "hsl(233, 45%, 9%)",
        "shifts-4": "hsl(233, 45%, 6%)",
        "shifts-5": "hsl(233, 45%, 3%)",
        "shifts-unassigned": "hsl(233, 20%, 20%)"
      },
    },
  },
  theme2: {
    ...
    styles: {
      light: {
        background: "hsl(48, 48%, 98%)",
        foreground: "hsl(48, 77%, 1%)",
        muted: "hsl(228, 14%, 89%)",
        "muted-foreground": "hsl(228, 11%, 27%)",
        popover: "hsl(48, 48%, 97%)",
        "popover-foreground": "hsl(0, 0%, 0%)",
        card: "hsl(48, 48%, 97%)",
        "card-foreground": "hsl(0, 0%, 0%)",
        border: "hsl(48, 6%, 88%)",
        input: "hsl(48, 6%, 88%)",
        primary: "hsl(48, 100%, 83%)",
        "primary-foreground": "hsl(48, 100%, 3%)",
        secondary: "hsl(228, 100%, 83%)",
        "secondary-foreground": "hsl(228, 100%, 23%)",
        accent: "hsl(228, 100%, 83%)",
        "accent-foreground": "hsl(228, 100%, 23%)",
        destructive: "hsl(14, 99%, 22%)",
        "destructive-foreground": "hsl(14, 99%, 82%)",
        ring: "hsl(48, 100%, 83%)",
        "chart-1": "hsl(48, 100%, 83%)",
        "chart-2": "hsl(228, 100%, 83%)",
        "chart-3": "hsl(228, 100%, 83%)",
        "chart-4": "hsl(228, 100%, 86%)",
        "chart-5": "hsl(48, 103%, 83%)",
        radius: "0.5rem",
        sidebar: "hsl(48, 48%, 99%)",
        "sidebar-foreground": "hsl(0, 0%, 0%)",
        "sidebar-primary": "hsl(48, 100%, 83%)",
        "sidebar-primary-foreground": "hsl(48, 100%, 3%)",
        "sidebar-accent": "hsl(228, 100%, 83%)",
        "sidebar-accent-foreground": "hsl(228, 100%, 23%)",
        "sidebar-border": "hsl(48, 6%, 88%)",
        "sidebar-ring": "hsl(48, 100%, 83%)",
        "font-sans": "Inter, sans-serif",
        "font-serif": "Georgia, serif",
        "font-mono": "Menlo, monospace",
        "shifts-1": "hsl(48, 90%, 80%)",
        "shifts-2": "hsl(48, 90%, 75%)",
        "shifts-3": "hsl(48, 90%, 70%)",
        "shifts-4": "hsl(48, 90%, 65%)",
        "shifts-5": "hsl(48, 90%, 60%)",
        "shifts-unassigned": "hsl(48, 50%, 90%)"
      },
      dark: {
        background: "hsl(48, 44%, 0%)",
        foreground: "hsl(48, 39%, 99%)",
        muted: "hsl(228, 14%, 11%)",
        "muted-foreground": "hsl(228, 11%, 73%)",
        popover: "hsl(0, 0%, 1%)",
        ...
        "sidebar-accent": "hsl(228, 100%, 83%)",
        "sidebar-accent-foreground": "hsl(228, 100%, 23%)",
        "sidebar-border": "hsl(48, 6%, 11%)",
        "sidebar-ring": "hsl(48, 100%, 83%)",
        "font-sans": "Inter, sans-serif",
        "font-serif": "Georgia, serif",
        "font-mono": "Menlo, monospace",
        "shifts-1": "hsl(48, 80%, 25%)",
        "shifts-2": "hsl(48, 80%, 20%)",
        "shifts-3": "hsl(48, 80%, 15%)",
        "shifts-4": "hsl(48, 80%, 10%)",
        "shifts-5": "hsl(48, 80%, 5%)",
        "shifts-unassigned": "hsl(48, 50%, 30%)"
      },
    },
  },
  theme3: {
    ...
    styles: {
      light: {
        background: "hsl(96, 38%, 100%)",
        foreground: "hsl(96, 66%, 4%)",
        muted: "hsl(216, 6%, 88%)",
        "muted-foreground": "hsl(216, 15%, 34%)",
        popover: "hsl(96, 38%, 100%)",
        "popover-foreground": "hsl(96, 66%, 4%)",
        card: "hsl(0, 0%, 99%)",
        "card-foreground": "hsl(96, 66%, 3%)",
        border: "hsl(96, 15%, 93%)",
        input: "hsl(96, 15%, 93%)",
        primary: "hsl(96, 51%, 90%)",
        "primary-foreground": "hsl(96, 51%, 10%)",
        secondary: "hsl(216, 51%, 90%)",
        "secondary-foreground": "hsl(216, 51%, 30%)",
        accent: "hsl(336, 51%, 90%)",
        "accent-foreground": "hsl(336, 51%, 30%)",
        destructive: "hsl(15, 100%, 37%)",
        "destructive-foreground": "hsl(0, 0%, 100%)",
        ring: "hsl(96, 51%, 90%)",
        "chart-1": "hsl(96, 51%, 90%)",
        "chart-2": "hsl(216, 51%, 90%)",
        "chart-3": "hsl(336, 51%, 90%)",
        "chart-4": "hsl(216, 51%, 93%)",
        "chart-5": "hsl(96, 54%, 90%)",
        radius: "0.5rem",
        sidebar: "hsl(96, 38%, 99%)",
        "sidebar-foreground": "hsl(96, 66%, 4%)",
        "sidebar-primary": "hsl(96, 51%, 90%)",
        "sidebar-primary-foreground": "hsl(96, 51%, 10%)",
        "sidebar-accent": "hsl(336, 51%, 90%)",
        "sidebar-accent-foreground": "hsl(336, 51%, 30%)",
        "sidebar-border": "hsl(96, 15%, 93%)",
        "sidebar-ring": "hsl(96, 51%, 90%)",
        "font-sans": "Inter, sans-serif",
        "font-serif": "Georgia, serif",
        "font-mono": "Menlo, monospace",
        "shifts-1": "hsl(96, 45%, 85%)",
        "shifts-2": "hsl(96, 45%, 80%)",
        "shifts-3": "hsl(96, 45%, 75%)",
        "shifts-4": "hsl(96, 45%, 70%)",
        "shifts-5": "hsl(96, 45%, 65%)",
        "shifts-unassigned": "hsl(96, 20%, 95%)"
      },
      dark: {
        background: "hsl(96, 36%, 1%)",
        foreground: "hsl(96, 22%, 97%)",
        muted: "hsl(216, 6%, 12%)",
        "muted-foreground": "hsl(216, 15%, 66%)",
        popover: "hsl(96, 36%, 1%)",
        "popover-foreground": "hsl(96, 22%, 97%)",
        card: "hsl(96, 36%, 2%)",
        "card-foreground": "hsl(96, 22%, 98%)",
        border: "hsl(96, 15%, 14%)",
        input: "hsl(96, 15%, 14%)",
        primary: "hsl(96, 51%, 90%)",
        "primary-foreground": "hsl(96, 51%, 10%)",
        ...
        radius: "0.5rem",
        sidebar: "hsl(96, 36%, 2%)",
        "sidebar-foreground": "hsl(96, 22%, 97%)",
        "sidebar-primary": "hsl(96, 51%, 90%)",
        "sidebar-primary-foreground": "hsl(96, 51%, 10%)",
        "sidebar-accent": "hsl(336, 51%, 90%)",
        "sidebar-accent-foreground": "hsl(336, 51%, 30%)",
        "sidebar-border": "hsl(96, 15%, 14%)",
        "sidebar-ring": "hsl(96, 51%, 90%)",
        "font-sans": "Inter, sans-serif",
        "font-serif": "Georgia, serif",
        "font-mono": "Menlo, monospace",
        "shifts-1": "hsl(96, 40%, 20%)",
        "shifts-2": "hsl(96, 40%, 15%)",
        "shifts-3": "hsl(96, 40%, 10%)",
        "shifts-4": "hsl(96, 40%, 5%)",
        "shifts-5": "hsl(96, 40%, 3%)",
        "shifts-unassigned": "hsl(96, 20%, 25%)"
      },
    },
  },
  theme4: {
    ...
    styles: {
      light: {
        ...
        "sidebar-primary": "#645331",
        "sidebar-primary-foreground": "#f8fafc",
        "sidebar-accent": "#ded5b6",
  ...
  theme5: {
    ...
    styles: {
      light: {
        background: "hsl(78, 63%, 99%)",
        foreground: "hsl(78, 78%, 3%)",
        muted: "hsl(48, 10%, 92%)",
        "muted-foreground": "hsl(48, 7%, 38%)",
        popover: "hsl(78, 63%, 99%)",
        "popover-foreground": "hsl(78, 78%, 3%)",
        card: "hsl(78, 63%, 98%)",
        "card-foreground": "hsl(78, 78%, 2%)",
        border: "hsl(78, 8%, 93%)",
        input: "hsl(78, 8%, 93%)",
        primary: "hsl(78, 32%, 75%)",
        "primary-foreground": "hsl(78, 32%, 15%)",
        secondary: "hsl(48, 32%, 75%)",
        "secondary-foreground": "hsl(48, 32%, 15%)",
        accent: "hsl(108, 32%, 75%)",
        "accent-foreground": "hsl(108, 32%, 15%)",
        destructive: "hsl(22, 87%, 26%)",
        "destructive-foreground": "hsl(22, 87%, 86%)",
        ring: "hsl(78, 32%, 75%)",
        "chart-1": "hsl(78, 32%, 75%)",
        "chart-2": "hsl(48, 32%, 75%)",
        "chart-3": "hsl(108, 32%, 75%)",
        "chart-4": "hsl(48, 32%, 78%)",
        "chart-5": "hsl(78, 35%, 75%)",
        radius: "0.5rem",
        sidebar: "hsl(78, 63%, 98%)",
        "sidebar-foreground": "hsl(78, 78%, 3%)",
        "sidebar-primary": "hsl(78, 32%, 75%)",
        "sidebar-primary-foreground": "hsl(78, 32%, 15%)",
        "sidebar-accent": "hsl(108, 32%, 75%)",
        "sidebar-accent-foreground": "hsl(108, 32%, 15%)",
        "sidebar-border": "hsl(78, 8%, 93%)",
        "sidebar-ring": "hsl(78, 32%, 75%)",
        "font-sans": "Inter, sans-serif",
        "font-serif": "Georgia, serif",
        "font-mono": "Menlo, monospace",
        "shifts-1": "hsl(78, 32%, 70%)",
        "shifts-2": "hsl(78, 32%, 65%)",
        "shifts-3": "hsl(78, 32%, 60%)",
        "shifts-4": "hsl(78, 32%, 55%)",
        "shifts-5": "hsl(78, 32%, 50%)",
        "shifts-unassigned": "hsl(78, 15%, 85%)"
      },
      dark: {
        background: "hsl(78, 57%, 4%)",
        foreground: "hsl(78, 18%, 100%)",
        muted: "hsl(48, 10%, 8%)",
        "muted-foreground": "hsl(48, 7%, 62%)",
        popover: "hsl(78, 57%, 4%)",
        "popover-foreground": "hsl(78, 18%, 100%)",
        card: "hsl(78, 57%, 5%)",
        "card-foreground": "hsl(0, 0%, 100%)",
        border: "hsl(78, 8%, 10%)",
        input: "hsl(78, 8%, 10%)",
        ...
        radius: "0.5rem",
        sidebar: "hsl(78, 57%, 5%)",
        "sidebar-foreground": "hsl(78, 18%, 100%)",
        "sidebar-primary": "hsl(78, 32%, 75%)",
        "sidebar-primary-foreground": "hsl(78, 32%, 15%)",
        "sidebar-accent": "hsl(108, 32%, 75%)",
        "sidebar-accent-foreground": "hsl(108, 32%, 15%)",
        "sidebar-border": "hsl(78, 8%, 10%)",
        "sidebar-ring": "hsl(78, 32%, 75%)",
        "font-sans": "Inter, sans-serif",
        "font-serif": "Georgia, serif",
        "font-mono": "Menlo, monospace",
        "shifts-1": "hsl(78, 32%, 20%)",
        "shifts-2": "hsl(78, 32%, 15%)",
        "shifts-3": "hsl(78, 32%, 10%)",
        "shifts-4": "hsl(78, 32%, 5%)",
        "shifts-5": "hsl(78, 32%, 3%)",
        "shifts-unassigned": "hsl(78, 15%, 25%)"
      },
    },
  },
  theme6: {
    ...
    styles: {
      light: {
        background: "hsl(125, 30%, 98%)",
        foreground: "hsl(125, 76%, 1%)",
        muted: "hsl(245, 12%, 90%)",
        "muted-foreground": "hsl(245, 12%, 36%)",
        popover: "hsl(125, 30%, 98%)",
        "popover-foreground": "hsl(125, 76%, 1%)",
        card: "hsl(125, 30%, 98%)",
        "card-foreground": "hsl(125, 76%, 1%)",
        border: "hsl(125, 9%, 88%)",
        input: "hsl(125, 9%, 88%)",
        primary: "hsl(170.11, 100%, 17.84%)",
        "primary-foreground": "hsl(0, 0%, 100%)",
        secondary: "hsl(68.52, 81.48%, 42.35%)",
        "secondary-foreground": "hsl(0, 0%, 100%)",
        accent: "hsl(170.11, 32.63%, 81.73%)",
        "accent-foreground": "hsl(0, 0%, 9%)",
        destructive: "hsl(2, 80%, 43%)",
        "destructive-foreground": "hsl(0, 0%, 100%)",
        ring: "hsl(125, 41%, 16%)",
        "chart-1": "hsl(125, 41%, 16%)",
        "chart-2": "hsl(245, 41%, 16%)",
        "chart-3": "hsl(5, 41%, 16%)",
        "chart-4": "hsl(245, 41%, 19%)",
        "chart-5": "hsl(125, 44%, 16%)",
        radius: "0.5rem",
        sidebar: "hsl(125, 30%, 99%)",
        "sidebar-foreground": "hsl(125, 76%, 1%)",
        "sidebar-primary": "hsl(170.11, 100%, 17.84%)",
        "sidebar-primary-foreground": "hsl(0, 0%, 100%)",
        "sidebar-accent": "hsl(170.11, 32.63%, 81.73%)",
        "sidebar-accent-foreground": "hsl(0, 0%, 9%)",
        "sidebar-border": "hsl(125, 9%, 88%)",
        "sidebar-ring": "hsl(125, 41%, 16%)",
        "font-sans": "Inter, sans-serif",
        "font-serif": "Georgia, serif",
        "font-mono": "Menlo, monospace",
        "shifts-1": "hsl(170.11, 90%, 20%)",
        "shifts-2": "hsl(170.11, 90%, 25%)",
        "shifts-3": "hsl(170.11, 90%, 30%)",
        "shifts-4": "hsl(170.11, 90%, 35%)",
        "shifts-5": "hsl(170.11, 90%, 40%)",
        "shifts-unassigned": "hsl(170.11, 50%, 85%)"
      },
      dark: {
        background: "hsl(125, 32%, 3%)",
        foreground: "hsl(125, 27%, 98%)",
        muted: "hsl(245, 12%, 10%)",
        "muted-foreground": "hsl(245, 12%, 64%)",
        popover: "hsl(125, 32%, 3%)",
        "popover-foreground": "hsl(125, 27%, 98%)",
        card: "hsl(125, 32%, 3%)",
        "card-foreground": "hsl(125, 27%, 98%)",
        border: "hsl(125, 9%, 12%)",
        input: "hsl(125, 9%, 12%)",
        primary: "hsl(170.11, 100%, 17.84%)",
        "primary-foreground": "hsl(0, 0%, 100%)",
        secondary: "hsl(68.52, 81.48%, 42.35%)",
        "secondary-foreground": "hsl(0, 0%, 100%)",
        accent: "hsl(170.32, 89.21%, 7.32%)",
        "accent-foreground": "hsl(0, 0%, 100%)",
        destructive: "hsl(2, 80%, 50%)",
        "destructive-foreground": "hsl(0, 0%, 100%)",
        ring: "hsl(125, 41%, 16%)",
        "chart-1": "hsl(125, 41%, 16%)",
        "chart-2": "hsl(245, 41%, 16%)",
        ...
        "chart-5": "hsl(125, 44%, 16%)",
        radius: "0.5rem",
        sidebar: "hsl(125, 32%, 4%)",
        "sidebar-foreground": "hsl(125, 27%, 98%)",
        "sidebar-primary": "hsl(170.11, 100%, 17.84%)",
        "sidebar-primary-foreground": "hsl(0, 0%, 100%)",
        "sidebar-accent": "hsl(170.32, 89.21%, 7.32%)",
        "sidebar-accent-foreground": "hsl(0, 0%, 100%)",
        "sidebar-border": "hsl(125, 9%, 12%)",
        "sidebar-ring": "hsl(125, 41%, 16%)",
        "font-sans": "Inter, sans-serif",
        "font-serif": "Georgia, serif",
        "font-mono": "Menlo, monospace",
        "shifts-1": "hsl(170.11, 80%, 15%)",
        "shifts-2": "hsl(170.11, 80%, 12%)",
        "shifts-3": "hsl(170.11, 80%, 9%)",
        "shifts-4": "hsl(170.11, 80%, 6%)",
        "shifts-5": "hsl(170.11, 80%, 3%)",
        "shifts-unassigned": "hsl(170.11, 50%, 20%)"
      },
    },
  },
  theme7: {
    ...
    styles: {
      light: {
        background: "hsl(157, 51%, 99%)",
        foreground: "hsl(157, 64%, 1%)",
        muted: "hsl(157, 13%, 92%)",
        "muted-foreground": "hsl(157, 3%, 35%)",
        popover: "hsl(157, 51%, 99%)",
        "popover-foreground": "hsl(157, 64%, 1%)",
        card: "hsl(157, 51%, 99%)",
        "card-foreground": "hsl(157, 64%, 1%)",
        border: "hsl(157, 9%, 91%)",
        input: "hsl(157, 9%, 91%)",
        primary: "hsl(157, 62%, 54%)",
        "primary-foreground": "hsl(157, 62%, 14%)",
        secondary: "hsl(157, 3%, 88%)",
        "secondary-foreground": "hsl(157, 3%, 28%)",
        accent: "hsl(157, 11%, 80%)",
        "accent-foreground": "hsl(157, 11%, 20%)",
        destructive: "hsl(8, 100%, 40%)",
        "destructive-foreground": "hsl(0, 0%, 100%)",
        ring: "hsl(157, 62%, 54%)",
        "chart-1": "hsl(157, 62%, 54%)",
        "chart-2": "hsl(157, 3%, 88%)",
        "chart-3": "hsl(157, 11%, 80%)",
        "chart-4": "hsl(157, 3%, 91%)",
        "chart-5": "hsl(157, 65%, 54%)",
        radius: "0.5rem",
        sidebar: "hsl(157, 51%, 98%)",
        "sidebar-foreground": "hsl(157, 64%, 1%)",
        "sidebar-primary": "hsl(157, 62%, 54%)",
        "sidebar-primary-foreground": "hsl(157, 62%, 14%)",
        "sidebar-accent": "hsl(157, 11%, 80%)",
        "sidebar-accent-foreground": "hsl(157, 11%, 20%)",
        "sidebar-border": "hsl(157, 9%, 91%)",
        "sidebar-ring": "hsl(157, 62%, 54%)",
        "font-sans": "Inter, sans-serif",
        "font-serif": "Georgia, serif",
        "font-mono": "Menlo, monospace",
        "shifts-1": "hsl(157, 60%, 50%)",
        "shifts-2": "hsl(157, 60%, 45%)",
        "shifts-3": "hsl(157, 60%, 40%)",
        "shifts-4": "hsl(157, 60%, 35%)",
        "shifts-5": "hsl(157, 60%, 30%)",
        "shifts-unassigned": "hsl(157, 30%, 85%)"
      },
      dark: {
        background: "hsl(157, 42%, 2%)",
        foreground: "hsl(157, 29%, 98%)",
        muted: "hsl(157, 13%, 8%)",
        "muted-foreground": "hsl(157, 3%, 65%)",
        popover: "hsl(157, 42%, 2%)",
        "popover-foreground": "hsl(157, 29%, 98%)",
        card: "hsl(157, 42%, 2%)",
        "card-foreground": "hsl(157, 29%, 98%)",
        border: "hsl(157, 9%, 14%)",
        input: "hsl(157, 9%, 14%)",
        primary: "hsl(157, 62%, 54%)",
        "primary-foreground": "hsl(157, 62%, 14%)",
        secondary: "hsl(157, 14%, 18%)",
        "secondary-foreground": "hsl(157, 14%, 78%)",
        accent: "hsl(157, 20%, 27%)",
        "accent-foreground": "hsl(157, 20%, 87%)",
        destructive: "hsl(8, 100%, 53%)",
        "destructive-foreground": "hsl(0, 0%, 100%)",
        ring: "hsl(157, 62%, 54%)",
        "chart-1": "hsl(157, 62%, 54%)",
        "chart-2": "hsl(157, 14%, 18%)",
        "chart-3": "hsl(157, 20%, 27%)",
        "chart-4": "hsl(157, 14%, 21%)",
        "chart-5": "hsl(157, 65%, 54%)",
        radius: "0.5rem",
        sidebar: "hsl(157, 42%, 3%)",
        "sidebar-foreground": "hsl(157, 29%, 98%)",
        "sidebar-primary": "hsl(157, 62%, 54%)",
        "sidebar-primary-foreground": "hsl(157, 62%, 14%)",
        "sidebar-accent": "hsl(157, 20%, 27%)",
        "sidebar-accent-foreground": "hsl(157, 20%, 87%)",
        "sidebar-border": "hsl(157, 9%, 14%)",
        "sidebar-ring": "hsl(157, 62%, 54%)",
        "font-sans": "Inter, sans-serif",
        "font-serif": "Georgia, serif",
        "font-mono": "Menlo, monospace",
        "shifts-1": "hsl(157, 50%, 20%)",
        "shifts-2": "hsl(157, 50%, 15%)",
        "shifts-3": "hsl(157, 50%, 10%)",
        "shifts-4": "hsl(157, 50%, 5%)",
        "shifts-5": "hsl(157, 50%, 3%)",
        "shifts-unassigned": "hsl(157, 30%, 25%)"
      },
    },
  },
  theme8: {
